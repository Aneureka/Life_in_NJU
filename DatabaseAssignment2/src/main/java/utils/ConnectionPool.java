...
public class ConnectionPool {
	...
	static {
		...
		dataSource.setJdbcUrl("jdbc:mysql://localhost:3306/shared_bike?useSSL=false&useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC&characterEncoding=UTF-8");
